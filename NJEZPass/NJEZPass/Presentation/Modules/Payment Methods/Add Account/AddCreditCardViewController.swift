...
class AddCreditCardViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 3:
            cellIdentifier = "MultiInputTextFieldCell"
        case 4:
            cellIdentifier = "SaveButtonCell"
        default:
            cellIdentifier = "DescriptionCell" // Does not Load
        }
