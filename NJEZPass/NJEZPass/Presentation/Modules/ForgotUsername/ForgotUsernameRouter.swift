...
extension ForgotUsernameRouter: IRouter {
    func perform(viewModel: Any) {
        //push viewcontroller
        if let viewModel = viewModel as? ForgotUsernameModel.PresentionModel {
        ...
        } else if let viewModel = viewModel as? ForgotUsernameModel.PresentionModel {
            if let route = viewModel.route {
                switch route.navigation {
