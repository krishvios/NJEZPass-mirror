//
//  LicensePlateTableViewCell.swift
//  NJEZPass
//
...
protocol LicensePlateEditDelegate: class {
...
class LicensePlateTableViewCell: UITableViewCell {
...
extension LicensePlateTableViewCell : ApolloTextInputFieldDelegate {
